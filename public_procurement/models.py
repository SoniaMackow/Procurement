...
class Contract(models.Model):
    ...
    value_contract = MoneyField(decimal_places=2, default=0, default_currency='PLN', max_digits=11)
...
class Procedure(models.Model):
    ...
    value = MoneyField(decimal_places=2, default=0, default_currency='PLN', max_digits=11)
    ...
    def get_absolute_url(self):
        return reverse('detail_procedure', args=(self.id,))
...
class CommentProcedure(models.Model):
    ...
    def __str__(self):
        return f"{self.text} {self.author} {self.procedure} {self.date}"
